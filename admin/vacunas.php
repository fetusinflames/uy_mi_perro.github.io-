...
<div class="table-container">
    <table class="pets-table">
        ...
        <tr>
            ...
            <td>
                <a href="eliminavac.php?accion=eliminevac&codigo=<?php echo $resultados["codigo"]; ?>" class="delete-link">Eliminar</a>
            </td>
            <td>
                <a href="editar_vacunas.php?accion=editar&codigo=<?php echo $resultados["codigo"]; ?>" class="delete-link">Editar</a>
            </td>
        </tr>
        <?php
        }
    ...
    <div class="login-container">
        <div class="login-form">
            <h1>INGRESA LAS VACUNAS </h1>
            
            <img src="img/pata.png" id="pata" alt="Pata superior">
        <?php
        
        ?>
            <form action="ingresa_vac.php?accion=ingresavacunas" method="post" id="formulario">
